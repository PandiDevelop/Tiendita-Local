const CACHE = 'mi-tiendita-v7';
const FILES = ['./','./index.html','./styles.css','./app.js','./fixes.js','./sync.js','./firebase-config.js','./manifest.webmanifest','./store-icon.svg','./icon-192.png','./icon-512.png'];
